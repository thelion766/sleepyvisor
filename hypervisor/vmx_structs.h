...
typedef union _KGDTENTRY64
{
    ...
    struct
    {
        signed long long DataLow;
        signed long long DataHigh;
    };
} KGDTENTRY64, * PKGDTENTRY64;

typedef struct vp_state
{
    PCONTEXT vp_regs;
    UINT64 guest_rip;
    UINT64 guest_rsp;
...
typedef struct special_registers_t
{
    UINT64 Cr0;
    UINT64 Cr3;
    UINT64 Cr4;
...
static_assert(sizeof(MTRR_CAPABILITIES) == sizeof(UINT64));
...
static_assert(sizeof(MTRR_VARIABLE_BASE) == sizeof(UINT64));
...
static_assert(sizeof(MTRR_VARIABLE_MASK) == sizeof(UINT64));
